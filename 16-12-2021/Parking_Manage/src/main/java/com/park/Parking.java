...
public class Parking extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
		    ...
		    st2.executeUpdate(); 
			String query3="select slot_code from floors where floor_number=? and status_of_slot= 'EMPTY' limit 1 ";
			...
			if(cnt==1)
			{
		        ...
		        out.println("</body>");
		        out.println("</html>");
				out.println("<meta http-equiv='refresh' content='3;URL=customeroperations.jsp'>");
